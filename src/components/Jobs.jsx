...
export default function Jobs({ job }) {
  ...
  return (
    <div>
      <Link href={`/post/work/${job?._id}`} className='mt-4 flex justify-center'>
        <div className="w-full sm:w-[90%] md:w-[800px] items-center p-6 border border-gray-200 rounded-lg shadow-md bg-white hover:shadow-lg transition-shadow duration-200 gap-8 hover:bg-blue-100">
